...
@protocol SUNSlideSwitchView_iPhoneDelegate;
@interface SUNSlideSwitchView_iPhone : UIView<UIScrollViewDelegate>
{
    ...
    __weak id<SUNSlideSwitchView_iPhoneDelegate> _slideSwitchViewDelegate;
}
...
@property (nonatomic, weak) IBOutlet id<SUNSlideSwitchView_iPhoneDelegate> slideSwitchViewDelegate;
 ...
 * @result
 */
- (void)slideSwitchView:(SUNSlideSwitchView_iPhone *)view panRightEdge:(UIPanGestureRecognizer*) panParam;
