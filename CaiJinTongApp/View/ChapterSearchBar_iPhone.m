...
-(void)layoutSubviews{
    ...
    if([[UIDevice currentDevice] systemVersion].floatValue >= 7.0){
        self.searchTextField.frame = (CGRect){CGRectGetMaxX(self.searchBt.frame),6 ,CGRectGetWidth(self.backImageView.frame) - CGRectGetMaxX(self.searchBt.frame) - 13,CGRectGetHeight(self.backImageView.frame) - 12};
    }else{
        self.searchTextField.frame = (CGRect){CGRectGetMaxX(self.searchBt.frame),6 ,CGRectGetWidth(self.backImageView.frame) - CGRectGetMaxX(self.searchBt.frame) - 13,CGRectGetHeight(self.backImageView.frame) -10};
    }
}
